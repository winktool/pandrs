...
fn main() -> Result<(), Error> {
    ...
    let category = vec![
        "Electronics".to_string(), "Electronics".to_string(), "Electronics".to_string(), "Electronics".to_string(),
        "Furniture".to_string(), "Furniture".to_string(), "Furniture".to_string(), "Furniture".to_string(),
    ];
    ...
    let product = vec![
        "TV".to_string(), "TV".to_string(), "Computer".to_string(), "Computer".to_string(),
        "Table".to_string(), "Table".to_string(), "Chair".to_string(), "Chair".to_string(),
    ];
