...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 1. Create line chart
    {
        ...
        let mut chart = ChartBuilder::on(&root)
            .caption("Plotters Line Chart Example", ("sans-serif", 30).into_font())
            .margin(10)
    ...
    // 2. Create scatter plot
    {
        ...
        let mut chart = ChartBuilder::on(&root)
            .caption("Plotters Scatter Plot Example", ("sans-serif", 30).into_font())
            .margin(10)
            .x_label_area_size(30)
            .y_label_area_size(40)
            .build_cartesian_2d(0.0..10.0, -1.2..1.2)?;
    ...
    // 5. Create area chart (SVG format)
    {
        ...
        let mut chart = ChartBuilder::on(&root)
            .caption("Plotters Area Chart Example", ("sans-serif", 30).into_font())
            .margin(10)
            .x_label_area_size(30)
            .y_label_area_size(40)
