...
fn optimized_descriptive_stats_example() -> Result<()> {
    ...
    df.add_column("Values".to_string(), pandrs::Column::Float64(pandrs::column::Float64Column::new(values.clone())))?;
...
fn optimized_ttest_example() -> Result<()> {
    ...
    df.add_column("Group 1".to_string(), pandrs::Column::Float64(pandrs::column::Float64Column::new(group1.clone())))?;
    df.add_column("Group 2".to_string(), pandrs::Column::Float64(pandrs::column::Float64Column::new(group2.clone())))?;
